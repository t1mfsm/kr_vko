...
# Максимальное ожидание результата выстрела. Результат определяется по
# исчезновению цели или по двум новым координатам после пуска.
...
# Время автопополнения боекомплекта (секунды), 0 = немедленно
AMMO_REFILL_TIME=0
